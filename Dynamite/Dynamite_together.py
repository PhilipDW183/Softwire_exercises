...
class UltimateBot:
    ...
    def check_dynamite_strat(self, opponent_moves, my_moves):

        return opponent_moves[1] == my_moves[1] and opponent_moves[2] == "D"
    ...
    def make_move(self, gamestate):
        ...
        if rounds > 2:
            ...
            if self.draws >= 2 and self.check_dynamite_strat(opponents_last_3_moves, my_last_3_moves):
                return "W"
        ...
        if self.draws >= 1:
            ...
            if self.opponent_dynamite_used < 100:
                ...
                if prob == 2 and self.dynamite_used < 99:
                    self.dynamite_used += 1
                    return "D"
                else:
                    return random.choice(self.base_choices)

            elif self.dynamite_used < 99:
                self.dynamite_used += 1
                return "D"
